  ...
  return (
    <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} class="relative inline-block">
      <div
        ...
        } ${isHovered() ? 'bg-gray-200' : `bg-[${defaultBackgroundColor}]`} border border-gray-300 rounded-md`}
      >
      ...
      {props.disabled && (
        <div class="absolute inset-0 bg-gray-200 flex items-center justify-center z-10 rounded-md">
